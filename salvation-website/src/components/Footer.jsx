      ...
      <div className="footer-main">
        ...
        <div className="footer-col brand-col">
          ...
          <div className="social-row" role="list">
            <a href="https://www.facebook.com/share/1Tqkzsa5f4/?mibextid=wwXIfr" target="_blank" rel="noreferrer" className="social-icon" title="Facebook" aria-label="Facebook" role="listitem">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" width="18" height="18">
                <path d="M18 2h-3a5 5 0 0 0-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 0 1 1-1h3z"/>
              </svg>
            </a>
            <a href="https://www.tiktok.com/@ifeanyi6790?_r=1&_t=ZS-96vsc7jMe2v" target="_blank" rel="noreferrer" className="social-icon" title="TikTok" aria-label="TikTok" role="listitem">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" width="18" height="18">
                <path d="M19.59 6.69a4.83 4.83 0 0 1-3.77-4.25V2h-3.45v13.67a2.89 2.89 0 0 1-2.88 2.5 2.89 2.89 0 0 1-2.89-2.89 2.89 2.89 0 0 1 2.89-2.89c.28 0 .54.04.79.1V9.01a6.33 6.33 0 0 0-.79-.05 6.34 6.34 0 0 0-6.34 6.34 6.34 6.34 0 0 0 6.34 6.34 6.34 6.34 0 0 0 6.33-6.34V8.69a8.18 8.18 0 0 0 4.78 1.52V6.76a4.85 4.85 0 0 1-1.01-.07z"/>
              </svg>
            </a>
            <a href="https://www.instagram.com/ifeanyi52562?igsh=Y2RpN2s1dHNvMXJ4&utm_source=qr" target="_blank" rel="noreferrer" className="social-icon" title="Instagram" aria-label="Instagram" role="listitem">
            ...
            <a href="https://youtube.com/@ifeanyiohiri1977?si=3Vf2z_6FLkBmBOQq" target="_blank" rel="noreferrer" className="social-icon" title="YouTube" aria-label="YouTube" role="listitem">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" width="18" height="18">
